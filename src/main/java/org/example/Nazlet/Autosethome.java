...
public class Autosethome {

    boolean state = false;
    private static Thread backgroundThread; // référence au thread lancé

    public Autosethome() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {

        JFrame frame = new JFrame("Autosethome");
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        Autosethome autosethome = new Autosethome();
